  ...
  <div class="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div v-if="loading" class="text-center py-20">
        <div class="inline-block animate-spin rounded-full h-12 w-12 border-4 border-green-400 border-t-transparent"></div>
...
<ul 
  ...
  role="list"
  :aria-label="`Lista de ${currentCategory.name.toLowerCase()}`"
>
  ...
  <li v-for="item in currentItems" :key="item.id">
    ...
    >
      <!-- Imagen -->
      <div class="aspect-square p-4 bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center">
        <img
...
watch(activeCategory, async (newCategory) => {
  ...
  try {
    const { data } = useFetch(category.endpoint)
